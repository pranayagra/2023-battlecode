...
//    }
//    System.out.println("Miner getOptimalDirectionTowards START " + (Clock.getBytecodeNum()));
    ...
    int newLocDist; // temp
//    System.out.println("Miner optimal dir " + (Clock.getBytecodeNum()));
    for (Direction candidateDir : Utils.directions) {
//      System.out.println("Miner candidateDir " + (Clock.getBytecodeNum()));
...
//    }
//    System.out.println("Miner moveOptimalTowards START " + (Clock.getBytecodeNum()));
