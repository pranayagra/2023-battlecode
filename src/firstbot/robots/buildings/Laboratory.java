...
//    }
    ...
    if (!moving && rc.getTeamLeadAmount(Cache.Permanent.OUR_TEAM) >= MIN_LEAD_TO_TRANSMUTE && communicator.spawnInfo.getMinerMainCount() >= MIN_MINERS_TO_TRANSMUTE && rc.canTransmute()) {
      rc.transmute();
    }
