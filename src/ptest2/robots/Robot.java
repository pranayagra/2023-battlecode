...
import ptest2.communications.RunningMemory;
import ptest2.robots.micro.AttackMicro;
import ptest2.robots.micro.AttackerFightingMicro;
import ptest2.robots.pathfinding.Pathing;
import ptest2.utils.Cache;
import ptest2.utils.Global;
...
//      if (rc.getType() == RobotType.LAUNCHER) System.out.println("GGBYTECODEPT2");
