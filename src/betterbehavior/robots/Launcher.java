package betterbehavior.robots;

import betterbehavior.communications.CommsHandler;
...
import betterbehavior.containers.HashSet;
import betterbehavior.knowledge.Cache;
import betterbehavior.knowledge.RunningMemory;
import betterbehavior.robots.micro.AttackMicro;
import betterbehavior.robots.micro.AttackerFightingMicro;
import betterbehavior.utils.Constants;
import betterbehavior.utils.Printer;
...
public class Launcher extends MobileRobot {
  ...
  protected void runTurn() throws GameActionException {
    ...
    if (didAnyMicro) {
      ...
      if (target != null) {
        /*betterbehavior_ONLY*///rc.setIndicatorDot(target, 0, 0, 255);
...
//            targetLocation = explorationTarget;
      ...
      /*betterbehavior_ONLY*///rc.setIndicatorLine(Cache.PerTurn.CURRENT_LOCATION, patrolLocation, 200,200,200);
      return false;
    }
  }
