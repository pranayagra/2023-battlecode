...
package simplelaunchermacro.robots.pathfinding.unitpathing;

import battlecode.common.*;
import simplelaunchermacro.utils.Cache;
import simplelaunchermacro.utils.Utils;

public class BoosterPathing implements UnitPathing {
    ...
    public BoosterPathing(RobotController rc) {
        this.rc = rc;
    }
    ...
    public Direction bestDir(MapLocation target) throws GameActionException {
        ...
        int moveCooldown = RobotType.BOOSTER.movementCooldown;

        int shiftedMoveCD = moveCooldown << 3;
        ...
        switch (target_dx) {
                case -4:
                    switch (target_dy) {
                        case -2:
                            return Utils.directions[d$x_4$y_2 & 0b111]; // dir$x_4$y_2; // destination is at relative location (-4, -2)
                        case -1:
                            return Utils.directions[d$x_4$y_1 & 0b111]; // dir$x_4$y_1; // destination is at relative location (-4, -1)
                        case 0:
                            return Utils.directions[d$x_4$y0 & 0b111]; // dir$x_4$y0; // destination is at relative location (-4, 0)
                        case 1:
                            return Utils.directions[d$x_4$y1 & 0b111]; // dir$x_4$y1; // destination is at relative location (-4, 1)
                        case 2:
                            return Utils.directions[d$x_4$y2 & 0b111]; // dir$x_4$y2; // destination is at relative location (-4, 2)
                    }
                    break;
                case -3:
                    switch (target_dy) {
                        case -3:
                            return Utils.directions[d$x_3$y_3 & 0b111]; // dir$x_3$y_3; // destination is at relative location (-3, -3)
                        case -2:
                            return Utils.directions[d$x_3$y_2 & 0b111]; // dir$x_3$y_2; // destination is at relative location (-3, -2)
                        case -1:
                            return Utils.directions[d$x_3$y_1 & 0b111]; // dir$x_3$y_1; // destination is at relative location (-3, -1)
                        case 0:
                            return Utils.directions[d$x_3$y0 & 0b111]; // dir$x_3$y0; // destination is at relative location (-3, 0)
                        case 1:
                            return Utils.directions[d$x_3$y1 & 0b111]; // dir$x_3$y1; // destination is at relative location (-3, 1)
                        case 2:
                            return Utils.directions[d$x_3$y2 & 0b111]; // dir$x_3$y2; // destination is at relative location (-3, 2)
                        case 3:
                            return Utils.directions[d$x_3$y3 & 0b111]; // dir$x_3$y3; // destination is at relative location (-3, 3)
                    }
                    break;
                case -2:
                    switch (target_dy) {
                        case -4:
                            return Utils.directions[d$x_2$y_4 & 0b111]; // dir$x_2$y_4; // destination is at relative location (-2, -4)
                        case -3:
                            return Utils.directions[d$x_2$y_3 & 0b111]; // dir$x_2$y_3; // destination is at relative location (-2, -3)
                        case -2:
                            return Utils.directions[d$x_2$y_2 & 0b111]; // dir$x_2$y_2; // destination is at relative location (-2, -2)
                        case -1:
                            return Utils.directions[d$x_2$y_1 & 0b111]; // dir$x_2$y_1; // destination is at relative location (-2, -1)
                        case 0:
                            return Utils.directions[d$x_2$y0 & 0b111]; // dir$x_2$y0; // destination is at relative location (-2, 0)
                        case 1:
                            return Utils.directions[d$x_2$y1 & 0b111]; // dir$x_2$y1; // destination is at relative location (-2, 1)
                        case 2:
                            return Utils.directions[d$x_2$y2 & 0b111]; // dir$x_2$y2; // destination is at relative location (-2, 2)
                        case 3:
                            return Utils.directions[d$x_2$y3 & 0b111]; // dir$x_2$y3; // destination is at relative location (-2, 3)
                        case 4:
                            return Utils.directions[d$x_2$y4 & 0b111]; // dir$x_2$y4; // destination is at relative location (-2, 4)
                    }
                    break;
                case -1:
                    switch (target_dy) {
                        case -4:
                            return Utils.directions[d$x_1$y_4 & 0b111]; // dir$x_1$y_4; // destination is at relative location (-1, -4)
                        case -3:
                            return Utils.directions[d$x_1$y_3 & 0b111]; // dir$x_1$y_3; // destination is at relative location (-1, -3)
                        case -2:
                            return Utils.directions[d$x_1$y_2 & 0b111]; // dir$x_1$y_2; // destination is at relative location (-1, -2)
                        case -1:
                            return Utils.directions[d$x_1$y_1 & 0b111]; // dir$x_1$y_1; // destination is at relative location (-1, -1)
                        case 0:
                            return Utils.directions[d$x_1$y0 & 0b111]; // dir$x_1$y0; // destination is at relative location (-1, 0)
                        case 1:
                            return Utils.directions[d$x_1$y1 & 0b111]; // dir$x_1$y1; // destination is at relative location (-1, 1)
                        case 2:
                            return Utils.directions[d$x_1$y2 & 0b111]; // dir$x_1$y2; // destination is at relative location (-1, 2)
                        case 3:
                            return Utils.directions[d$x_1$y3 & 0b111]; // dir$x_1$y3; // destination is at relative location (-1, 3)
                        case 4:
                            return Utils.directions[d$x_1$y4 & 0b111]; // dir$x_1$y4; // destination is at relative location (-1, 4)
                    }
                    break;
                case 0:
                    switch (target_dy) {
                        case -4:
                            return Utils.directions[d$x0$y_4 & 0b111]; // dir$x0$y_4; // destination is at relative location (0, -4)
                        case -3:
                            return Utils.directions[d$x0$y_3 & 0b111]; // dir$x0$y_3; // destination is at relative location (0, -3)
                        case -2:
                            return Utils.directions[d$x0$y_2 & 0b111]; // dir$x0$y_2; // destination is at relative location (0, -2)
                        case -1:
                            return Utils.directions[d$x0$y_1 & 0b111]; // dir$x0$y_1; // destination is at relative location (0, -1)
                        case 0:
                            return Utils.directions[d$x0$y0 & 0b111]; // dir$x0$y0; // destination is at relative location (0, 0)
                        case 1:
                            return Utils.directions[d$x0$y1 & 0b111]; // dir$x0$y1; // destination is at relative location (0, 1)
                        case 2:
                            return Utils.directions[d$x0$y2 & 0b111]; // dir$x0$y2; // destination is at relative location (0, 2)
                        case 3:
                            return Utils.directions[d$x0$y3 & 0b111]; // dir$x0$y3; // destination is at relative location (0, 3)
                        case 4:
                            return Utils.directions[d$x0$y4 & 0b111]; // dir$x0$y4; // destination is at relative location (0, 4)
                    }
                    break;
                case 1:
                    switch (target_dy) {
                        case -4:
                            return Utils.directions[d$x1$y_4 & 0b111]; // dir$x1$y_4; // destination is at relative location (1, -4)
                        case -3:
                            return Utils.directions[d$x1$y_3 & 0b111]; // dir$x1$y_3; // destination is at relative location (1, -3)
                        case -2:
                            return Utils.directions[d$x1$y_2 & 0b111]; // dir$x1$y_2; // destination is at relative location (1, -2)
                        case -1:
                            return Utils.directions[d$x1$y_1 & 0b111]; // dir$x1$y_1; // destination is at relative location (1, -1)
                        case 0:
                            return Utils.directions[d$x1$y0 & 0b111]; // dir$x1$y0; // destination is at relative location (1, 0)
                        case 1:
                            return Utils.directions[d$x1$y1 & 0b111]; // dir$x1$y1; // destination is at relative location (1, 1)
                        case 2:
                            return Utils.directions[d$x1$y2 & 0b111]; // dir$x1$y2; // destination is at relative location (1, 2)
                        case 3:
                            return Utils.directions[d$x1$y3 & 0b111]; // dir$x1$y3; // destination is at relative location (1, 3)
                        case 4:
                            return Utils.directions[d$x1$y4 & 0b111]; // dir$x1$y4; // destination is at relative location (1, 4)
                    }
                    break;
                case 2:
                    switch (target_dy) {
                        case -4:
                            return Utils.directions[d$x2$y_4 & 0b111]; // dir$x2$y_4; // destination is at relative location (2, -4)
                        case -3:
                            return Utils.directions[d$x2$y_3 & 0b111]; // dir$x2$y_3; // destination is at relative location (2, -3)
                        case -2:
                            return Utils.directions[d$x2$y_2 & 0b111]; // dir$x2$y_2; // destination is at relative location (2, -2)
                        case -1:
                            return Utils.directions[d$x2$y_1 & 0b111]; // dir$x2$y_1; // destination is at relative location (2, -1)
                        case 0:
                            return Utils.directions[d$x2$y0 & 0b111]; // dir$x2$y0; // destination is at relative location (2, 0)
                        case 1:
                            return Utils.directions[d$x2$y1 & 0b111]; // dir$x2$y1; // destination is at relative location (2, 1)
                        case 2:
                            return Utils.directions[d$x2$y2 & 0b111]; // dir$x2$y2; // destination is at relative location (2, 2)
                        case 3:
                            return Utils.directions[d$x2$y3 & 0b111]; // dir$x2$y3; // destination is at relative location (2, 3)
                        case 4:
                            return Utils.directions[d$x2$y4 & 0b111]; // dir$x2$y4; // destination is at relative location (2, 4)
                    }
                    break;
                case 3:
                    switch (target_dy) {
                        case -3:
                            return Utils.directions[d$x3$y_3 & 0b111]; // dir$x3$y_3; // destination is at relative location (3, -3)
                        case -2:
                            return Utils.directions[d$x3$y_2 & 0b111]; // dir$x3$y_2; // destination is at relative location (3, -2)
                        case -1:
                            return Utils.directions[d$x3$y_1 & 0b111]; // dir$x3$y_1; // destination is at relative location (3, -1)
                        case 0:
                            return Utils.directions[d$x3$y0 & 0b111]; // dir$x3$y0; // destination is at relative location (3, 0)
                        case 1:
                            return Utils.directions[d$x3$y1 & 0b111]; // dir$x3$y1; // destination is at relative location (3, 1)
                        case 2:
                            return Utils.directions[d$x3$y2 & 0b111]; // dir$x3$y2; // destination is at relative location (3, 2)
                        case 3:
                            return Utils.directions[d$x3$y3 & 0b111]; // dir$x3$y3; // destination is at relative location (3, 3)
                    }
                    break;
                case 4:
                    switch (target_dy) {
                        case -2:
                            return Utils.directions[d$x4$y_2 & 0b111]; // dir$x4$y_2; // destination is at relative location (4, -2)
                        case -1:
                            return Utils.directions[d$x4$y_1 & 0b111]; // dir$x4$y_1; // destination is at relative location (4, -1)
                        case 0:
                            return Utils.directions[d$x4$y0 & 0b111]; // dir$x4$y0; // destination is at relative location (4, 0)
                        case 1:
                            return Utils.directions[d$x4$y1 & 0b111]; // dir$x4$y1; // destination is at relative location (4, 1)
                        case 2:
                            return Utils.directions[d$x4$y2 & 0b111]; // dir$x4$y2; // destination is at relative location (4, 2)
                    }
                    break;
        }
        ...
        double score$x_4$y_2 = (currDist - Math.sqrt(l$x_4$y_2.distanceSquaredTo(target))) / (d$x_4$y_2 >>> 3);
        if (score$x_4$y_2 > bestScore) {
            bestScore = score$x_4$y_2;
            ans = d$x_4$y_2; // dir$x_4$y_2;
        }

        double score$x_4$y_1 = (currDist - Math.sqrt(l$x_4$y_1.distanceSquaredTo(target))) / (d$x_4$y_1 >>> 3);
        if (score$x_4$y_1 > bestScore) {
            bestScore = score$x_4$y_1;
            ans = d$x_4$y_1; // dir$x_4$y_1;
        }

        double score$x_4$y0 = (currDist - Math.sqrt(l$x_4$y0.distanceSquaredTo(target))) / (d$x_4$y0 >>> 3);
        if (score$x_4$y0 > bestScore) {
            bestScore = score$x_4$y0;
            ans = d$x_4$y0; // dir$x_4$y0;
        }

        double score$x_4$y1 = (currDist - Math.sqrt(l$x_4$y1.distanceSquaredTo(target))) / (d$x_4$y1 >>> 3);
        if (score$x_4$y1 > bestScore) {
            bestScore = score$x_4$y1;
            ans = d$x_4$y1; // dir$x_4$y1;
        }

        double score$x_4$y2 = (currDist - Math.sqrt(l$x_4$y2.distanceSquaredTo(target))) / (d$x_4$y2 >>> 3);
        if (score$x_4$y2 > bestScore) {
            bestScore = score$x_4$y2;
            ans = d$x_4$y2; // dir$x_4$y2;
        }

        double score$x_3$y_3 = (currDist - Math.sqrt(l$x_3$y_3.distanceSquaredTo(target))) / (d$x_3$y_3 >>> 3);
        if (score$x_3$y_3 > bestScore) {
            bestScore = score$x_3$y_3;
            ans = d$x_3$y_3; // dir$x_3$y_3;
        }

        double score$x_3$y_2 = (currDist - Math.sqrt(l$x_3$y_2.distanceSquaredTo(target))) / (d$x_3$y_2 >>> 3);
        if (score$x_3$y_2 > bestScore) {
            bestScore = score$x_3$y_2;
            ans = d$x_3$y_2; // dir$x_3$y_2;
        }

        double score$x_3$y2 = (currDist - Math.sqrt(l$x_3$y2.distanceSquaredTo(target))) / (d$x_3$y2 >>> 3);
        if (score$x_3$y2 > bestScore) {
            bestScore = score$x_3$y2;
            ans = d$x_3$y2; // dir$x_3$y2;
        }

        double score$x_3$y3 = (currDist - Math.sqrt(l$x_3$y3.distanceSquaredTo(target))) / (d$x_3$y3 >>> 3);
        if (score$x_3$y3 > bestScore) {
            bestScore = score$x_3$y3;
            ans = d$x_3$y3; // dir$x_3$y3;
        }

        double score$x_2$y_4 = (currDist - Math.sqrt(l$x_2$y_4.distanceSquaredTo(target))) / (d$x_2$y_4 >>> 3);
        if (score$x_2$y_4 > bestScore) {
            bestScore = score$x_2$y_4;
            ans = d$x_2$y_4; // dir$x_2$y_4;
        }

        double score$x_2$y_3 = (currDist - Math.sqrt(l$x_2$y_3.distanceSquaredTo(target))) / (d$x_2$y_3 >>> 3);
        if (score$x_2$y_3 > bestScore) {
            bestScore = score$x_2$y_3;
            ans = d$x_2$y_3; // dir$x_2$y_3;
        }

        double score$x_2$y3 = (currDist - Math.sqrt(l$x_2$y3.distanceSquaredTo(target))) / (d$x_2$y3 >>> 3);
        if (score$x_2$y3 > bestScore) {
            bestScore = score$x_2$y3;
            ans = d$x_2$y3; // dir$x_2$y3;
        }

        double score$x_2$y4 = (currDist - Math.sqrt(l$x_2$y4.distanceSquaredTo(target))) / (d$x_2$y4 >>> 3);
        if (score$x_2$y4 > bestScore) {
            bestScore = score$x_2$y4;
            ans = d$x_2$y4; // dir$x_2$y4;
        }

        double score$x_1$y_4 = (currDist - Math.sqrt(l$x_1$y_4.distanceSquaredTo(target))) / (d$x_1$y_4 >>> 3);
        if (score$x_1$y_4 > bestScore) {
            bestScore = score$x_1$y_4;
            ans = d$x_1$y_4; // dir$x_1$y_4;
        }

        double score$x_1$y4 = (currDist - Math.sqrt(l$x_1$y4.distanceSquaredTo(target))) / (d$x_1$y4 >>> 3);
        if (score$x_1$y4 > bestScore) {
            bestScore = score$x_1$y4;
            ans = d$x_1$y4; // dir$x_1$y4;
        }

        double score$x0$y_4 = (currDist - Math.sqrt(l$x0$y_4.distanceSquaredTo(target))) / (d$x0$y_4 >>> 3);
        if (score$x0$y_4 > bestScore) {
            bestScore = score$x0$y_4;
            ans = d$x0$y_4; // dir$x0$y_4;
        }

        double score$x0$y4 = (currDist - Math.sqrt(l$x0$y4.distanceSquaredTo(target))) / (d$x0$y4 >>> 3);
        if (score$x0$y4 > bestScore) {
            bestScore = score$x0$y4;
            ans = d$x0$y4; // dir$x0$y4;
        }

        double score$x1$y_4 = (currDist - Math.sqrt(l$x1$y_4.distanceSquaredTo(target))) / (d$x1$y_4 >>> 3);
        if (score$x1$y_4 > bestScore) {
            bestScore = score$x1$y_4;
            ans = d$x1$y_4; // dir$x1$y_4;
        }

        double score$x1$y4 = (currDist - Math.sqrt(l$x1$y4.distanceSquaredTo(target))) / (d$x1$y4 >>> 3);
        if (score$x1$y4 > bestScore) {
            bestScore = score$x1$y4;
            ans = d$x1$y4; // dir$x1$y4;
        }

        double score$x2$y_4 = (currDist - Math.sqrt(l$x2$y_4.distanceSquaredTo(target))) / (d$x2$y_4 >>> 3);
        if (score$x2$y_4 > bestScore) {
            bestScore = score$x2$y_4;
            ans = d$x2$y_4; // dir$x2$y_4;
        }

        double score$x2$y_3 = (currDist - Math.sqrt(l$x2$y_3.distanceSquaredTo(target))) / (d$x2$y_3 >>> 3);
        if (score$x2$y_3 > bestScore) {
            bestScore = score$x2$y_3;
            ans = d$x2$y_3; // dir$x2$y_3;
        }

        double score$x2$y3 = (currDist - Math.sqrt(l$x2$y3.distanceSquaredTo(target))) / (d$x2$y3 >>> 3);
        if (score$x2$y3 > bestScore) {
            bestScore = score$x2$y3;
            ans = d$x2$y3; // dir$x2$y3;
        }

        double score$x2$y4 = (currDist - Math.sqrt(l$x2$y4.distanceSquaredTo(target))) / (d$x2$y4 >>> 3);
        if (score$x2$y4 > bestScore) {
            bestScore = score$x2$y4;
            ans = d$x2$y4; // dir$x2$y4;
        }

        double score$x3$y_3 = (currDist - Math.sqrt(l$x3$y_3.distanceSquaredTo(target))) / (d$x3$y_3 >>> 3);
        if (score$x3$y_3 > bestScore) {
            bestScore = score$x3$y_3;
            ans = d$x3$y_3; // dir$x3$y_3;
        }

        double score$x3$y_2 = (currDist - Math.sqrt(l$x3$y_2.distanceSquaredTo(target))) / (d$x3$y_2 >>> 3);
        if (score$x3$y_2 > bestScore) {
            bestScore = score$x3$y_2;
            ans = d$x3$y_2; // dir$x3$y_2;
        }

        double score$x3$y2 = (currDist - Math.sqrt(l$x3$y2.distanceSquaredTo(target))) / (d$x3$y2 >>> 3);
        if (score$x3$y2 > bestScore) {
            bestScore = score$x3$y2;
            ans = d$x3$y2; // dir$x3$y2;
        }

        double score$x3$y3 = (currDist - Math.sqrt(l$x3$y3.distanceSquaredTo(target))) / (d$x3$y3 >>> 3);
        if (score$x3$y3 > bestScore) {
            bestScore = score$x3$y3;
            ans = d$x3$y3; // dir$x3$y3;
        }

        double score$x4$y_2 = (currDist - Math.sqrt(l$x4$y_2.distanceSquaredTo(target))) / (d$x4$y_2 >>> 3);
        if (score$x4$y_2 > bestScore) {
            bestScore = score$x4$y_2;
            ans = d$x4$y_2; // dir$x4$y_2;
        }

        double score$x4$y_1 = (currDist - Math.sqrt(l$x4$y_1.distanceSquaredTo(target))) / (d$x4$y_1 >>> 3);
        if (score$x4$y_1 > bestScore) {
            bestScore = score$x4$y_1;
            ans = d$x4$y_1; // dir$x4$y_1;
        }

        double score$x4$y0 = (currDist - Math.sqrt(l$x4$y0.distanceSquaredTo(target))) / (d$x4$y0 >>> 3);
        if (score$x4$y0 > bestScore) {
            bestScore = score$x4$y0;
            ans = d$x4$y0; // dir$x4$y0;
        }

        double score$x4$y1 = (currDist - Math.sqrt(l$x4$y1.distanceSquaredTo(target))) / (d$x4$y1 >>> 3);
        if (score$x4$y1 > bestScore) {
            bestScore = score$x4$y1;
            ans = d$x4$y1; // dir$x4$y1;
        }

        double score$x4$y2 = (currDist - Math.sqrt(l$x4$y2.distanceSquaredTo(target))) / (d$x4$y2 >>> 3);
