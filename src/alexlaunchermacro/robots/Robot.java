...
import alexlaunchermacro.communications.RunningMemory;
import alexlaunchermacro.robots.micro.AttackMicro;
import alexlaunchermacro.robots.micro.AttackerMovementMicro;
import alexlaunchermacro.robots.pathfinding.Pathing;
import alexlaunchermacro.utils.Cache;
import alexlaunchermacro.utils.Global;
...
//      case LAUNCHER: return new Launcher(rc);
      case LAUNCHER: return new LauncherAlex(rc);
