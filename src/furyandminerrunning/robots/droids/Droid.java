...
public abstract class Droid extends Robot {
  ...
  public Droid(RobotController rc) throws GameActionException {
    ...
    EXPLORATION_REACHED_RADIUS = Cache.Permanent.VISION_RADIUS_SQUARED/2;
  }
...
//          do {
            explorationTarget = new MapLocation(
                1 + Utils.rng.nextInt(3)*(Cache.Permanent.MAP_WIDTH/2-1),
                1 + Utils.rng.nextInt(3)*(Cache.Permanent.MAP_HEIGHT/2-1)
            );
